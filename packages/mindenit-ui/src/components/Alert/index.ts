...
export const alertVariants = tv(
	{
		base: 'border-fiod-400 box-border inline-flex h-auto min-h-8 w-full items-start justify-start gap-2 rounded-lg border bg-white p-2 dark:border-fiord-700 dark:bg-fiord-900 dark:text-white [&_svg]:size-5',
		variants: {
			status: {
