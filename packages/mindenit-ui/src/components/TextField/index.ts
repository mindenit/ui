...
export const textFieldVariants = tv({
	base: 'box-border inline-flex h-10 w-full min-w-48 items-stretch gap-2 rounded-lg border bg-white pl-3 pr-1 text-start has-[input:disabled]:cursor-not-allowed has-[input:disabled]:border-0 has-[input:disabled]:bg-fiord-200 has-[input:focus]:ring dark:bg-fiord-950 dark:has-[input:disabled]:bg-fiord-800 [&_button]:size-7 [&_button_svg]:size-4',
	variants: {
		variant: {
			default:
