...
export const textAreaVariants = cva(
	'box-border inline-flex w-full min-w-48 items-stretch gap-2 rounded-lg border bg-white p-3 text-start has-[textarea:disabled]:cursor-not-allowed has-[textarea:disabled]:border-0 has-[textarea:disabled]:bg-fiord-200 has-[textarea:focus]:ring dark:bg-fiord-950 dark:has-[textarea:disabled]:bg-fiord-800 [&_button]:size-7 [&_button_svg]:size-4',
	{
		variants: {
			variant: {
				default:
